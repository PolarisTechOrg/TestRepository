...
// ///////////////////////////CtpField to FcpField
// End////////////////////////////////
-(int) FtdcExchangeToFcpMarket:(NSString*) ctpExchange;
-(int) CtpProductClassToFcpProductClass:(char) ctpProductClass;
-(int) CtpOptionsTypeToFcpOptionsType:(char) ctpOptionsType;
